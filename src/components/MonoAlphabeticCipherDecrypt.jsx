...
const MonoAlphabeticCipherDecrypt = () => {
      ...
      console.log(keysSorted)
        ...
        if (parameters.additivecipherText.length) {
            ...
            for (let index = 0; index < parameters.additivecipherText.length; index++) {
                // let ascii = parameters.additivecipherText.toLowerCase().charCodeAt(index)
                // let shifted = ""
                ...
                //     // ascii - keyBe>122 ? ascii = 96+ (ascii -keyBe-122) :ascii= ascii - keyBe
                //     // shifted = String.fromCharCode(ascii+1)
                //     // Org = Org.concat(letterMap[s])
                // }
                if(keysSorted[counter]===parameters.additivecipherText.toLowerCase()[index]){
                ...
                // }
                // if(97 <= ascii && ascii <= 122){
                //     ascii - keyBe>122 ? ascii = 97+ (ascii -keyBe-122) :ascii= ascii - keyBe
                //     shifted = String.fromCharCode(ascii+1)
                //     Org = Org.concat(shifted)
                // }
...
export default MonoAlphabeticCipherDecrypt